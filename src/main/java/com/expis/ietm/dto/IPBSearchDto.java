...
public class IPBSearchDto {
	...
	/* 사용자 정의 변수 선언 */
	private String searchType;		//검색 조건 1 : 부품 번호 , 2 : RDN
	private String searchKeyWork;	//검색어
	private String searchToKey;		//검색어 - 2023.04.11 - 해당 교범내의 검색만 가능하도록 추가 - jingi.kim
}
