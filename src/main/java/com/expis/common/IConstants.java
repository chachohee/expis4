...
public class IConstants {
	...
	public static final String PROP_WEBDATA_SYSPATH	= "WEBDATA_SYSPATH";
	 ...
	 * 35	: 카이규격(KAI)
	 */
	public static final String SC_COND_IPB_PNM	= "0301";
	public static final String SC_COND_IPB_PNO	= "0302";
	public static final String SC_COND_IPB_NSN	= "0303";
	public static final String SC_COND_IPB_RDN	= "0304";
	public static final String SC_COND_IPB_KAI	= "0305";
	...
	public static final String OPT_MOBILEMENU_CMTO		= "01";
	public static final String OPT_MOBLIEMENU_MYTO		= "02";


	/**
	 * 버전 정보-유효목록- 에서 사용되는 페이지 번호
	 * */
	public static final int VER_MAIN_REALTOPCNT		= 12;
	public static final int VER_DETAIREALTOPCNT		= 10;
	public static final String ALL_BOOK				= "all";
	public static final String ORG_BOOK				= "org";
	 ...
	 * 파일 관련
	 */
	public static final int	FILE_UPLOAD_UUID		= 1;
	public static final int	FILE_UPLOAD_ORG			= 2;
	//public static final int	FILE_UPLOAD_ETC		= 3;
	 ...
	 * 김권식
	 */
	public static final String	PRINT_IP		= "localhost";
	public static final int	PRINT_PORT			= 7788;

	public static final String	BIZ_CODE_DF		= "localhost";




	/////////////////////////// ExpisCore IConstants //////////////////////////////
